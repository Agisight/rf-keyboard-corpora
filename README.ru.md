...
> **Языки:** [English](README.md) · **Русский** · [Тыва дыл](README.tyv.md)
...
> 3. Для академических целей для любого исследователя.
...
В случае долгого нажатия буквы в стандартной русской клавиатуре (например, как сейчас Е → [Ё]), ваши буквы должны иметь ближайшую похожую букву, через которую покажутся в случае создания расширенной «Клавиатуры РФ».
...
2. **Вычислите частоты** — на Hugging Face загрузите корпус и сделайте что-то подобное по инструкции на [этой странице](https://github.com/Agisight/rf-keyboard-corpora/blob/rf/hf_freq_analyze.md); есть встроенный механизм подсчёта данных вашего монокорпуса.
